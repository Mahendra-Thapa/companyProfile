import { HardHat, Home, Hospital } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          <div>
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              We have successfully managed numerous manpower supply and
              recruitment projects across the Gulf region, providing skilled and
              reliable human resources to various industries.
            </p>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            {
              title: "Construction",
              desc: "Skilled labor for infrastructure projects.",
              icon: HardHat,
            },
            {
              title: "Hospitality",
              desc: "Expert staff for hotels and resorts.",
              icon: Home,
            },
            {
              title: "Healthcare",
            ...
            >
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm text-3xl text-primary">
                <field.icon />
              </div>
