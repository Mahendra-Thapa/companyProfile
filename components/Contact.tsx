          ...
          <div className="grid lg:grid-cols-2 relative z-10">
            <div className="p-12 lg:p-20 text-white">
              ...
              <p className="text-slate-300 text-lg mb-12 leading-relaxed">
                We invite you to partner with us for reliable, skilled, and
                efficient manpower solutions. Together, we can create lasting
            ...
            <div className="bg-white p-12 lg:p-20">
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-5 bg-primary text-white font-black rounded-xl hover:bg-secondary transition-all shadow-xl shadow-primary/20 uppercase tracking-widest"
                >
                  Send Message
                </button>
              </form>
